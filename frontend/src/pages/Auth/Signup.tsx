  ...
  return (
    <div className="bg-surface-container-lowest border border-outline-variant rounded-pebble p-container-padding w-full max-w-md flex flex-col gap-lg">
      <div className="flex flex-col gap-sm text-center items-center">
        ...
        <h1 className="font-headline-lg text-headline-lg text-primary tracking-tighter">Create Account</h1>
        <p className="font-body-md text-body-md text-secondary">Start your interview preparation journey.</p>
      </div>
      ...
      <form className="flex flex-col gap-md" onSubmit={handleSubmit(onSubmit)}>
        <div className="grid grid-cols-2 gap-md">
          <div className="flex flex-col gap-xs">
            <label className="font-label-bold text-label-bold text-on-background" htmlFor="firstName">First Name</label>
            <input
          ...
          <div className="flex flex-col gap-xs">
            <label className="font-label-bold text-label-bold text-on-background" htmlFor="lastName">Last Name</label>
            <input
        ...
        <div className="flex flex-col gap-xs">
          <label className="font-label-bold text-label-bold text-on-background" htmlFor="signupEmail">Email</label>
          <input
        ...
        <div className="flex flex-col gap-xs">
          <label className="font-label-bold text-label-bold text-on-background" htmlFor="signupPassword">Password</label>
          <input
      ...
      <div className="text-center">
        <p className="font-label-sm text-label-sm text-secondary">
          ...
          <Link className="text-primary font-label-bold text-label-bold hover:underline" to="/login">Sign in</Link>
        </p>
      </div>
    </div>
  );
